...
bash ../../scripts/build-flatbuffers.sh
...
# FlatBuffers
bash scripts/package-and-upload.sh --name flatbuffers --version flatbuffers-<version>-release

# abseil-cpp
bash scripts/package-and-upload.sh --name absl --version absl-<version>-release
```
